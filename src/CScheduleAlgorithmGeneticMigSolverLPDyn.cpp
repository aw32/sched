...
*/
void CScheduleAlgorithmGeneticMigSolverLPDyn::solve(CScheduleAlgorithmGeneticMigDyn::CGeneticSchedule* schedule,
...
//	unsigned long long lp_max = 0xffffffffff; //2^40 -1
	...
	std::vector<CScheduleAlgorithmGeneticMigSolverLPDyn::Task> tasklist(pTasks->size());
...
int CScheduleAlgorithmGeneticMigSolverLPDyn::findTask(std::vector<CTaskCopy*>* tasks, int tid) {
