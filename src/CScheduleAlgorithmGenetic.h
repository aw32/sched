...
#ifndef __CSCHEDULEALGORITHMGENETIC_H__
#define __CSCHEDULEALGORITHMGENETIC_H__
#include <random>
#include <cstring>
...
namespace algorithm {
	...
	class CScheduleAlgorithmGenetic : public CScheduleAlgorithm {
		public:
		...
		public:
			CScheduleAlgorithmGenetic(std::vector<CResource*>& rResources, enum EGeneticFitnessType fitness);
			virtual ~CScheduleAlgorithmGenetic();
