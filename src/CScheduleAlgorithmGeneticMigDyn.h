...
#ifndef __CSCHEDULEALGORITHMGENETICMIGDYN_H__
#define __CSCHEDULEALGORITHMGENETICMIGDYN_H__
#include <random>
#include <cstring>
...
namespace algorithm {
	...
	class CScheduleAlgorithmGeneticMigDyn : public CScheduleAlgorithm {
		...
		public:
			CScheduleAlgorithmGeneticMigDyn(std::vector<CResource*>& rResources, enum EGeneticFitnessType fitness);
			virtual ~CScheduleAlgorithmGeneticMigDyn();
