...
CScheduleAlgorithmHEFT2::CScheduleAlgorithmHEFT2(std::vector<CResource*>& rResources)
	: CScheduleAlgorithm(rResources)
{
	mpEstimation = CEstimation::getEstimation();
}

CScheduleAlgorithmHEFT2::~CScheduleAlgorithmHEFT2() {
	delete mpEstimation;
	mpEstimation = 0;
}

int CScheduleAlgorithmHEFT2::init() {
	return 0;
}

void CScheduleAlgorithmHEFT2::fini() {
}

CSchedule* CScheduleAlgorithmHEFT2::compute(std::vector<CTaskCopy>* pTasks, std::vector<CTaskCopy*>* runningTasks, volatile int* interrupt, int updated) {
