...
CScheduleAlgorithmSimulatedAnnealingDyn::CScheduleAlgorithmSimulatedAnnealingDyn(std::vector<CResource*>& rResources, enum EGeneticFitnessType fitness)
	: CScheduleAlgorithmGeneticDyn(rResources, fitness)
{
...
CScheduleAlgorithmSimulatedAnnealingDyn::~CScheduleAlgorithmSimulatedAnnealingDyn(){
}

int CScheduleAlgorithmSimulatedAnnealingDyn::init() {
...
void CScheduleAlgorithmSimulatedAnnealingDyn::fini() {
	CScheduleAlgorithmGeneticDyn::fini();
}

void CScheduleAlgorithmSimulatedAnnealingDyn::randomize(CGeneticSchedule* schedule, int* height, int machines, int height_num, std::vector<int>* height_sets, int max_num){
...
CSchedule* CScheduleAlgorithmSimulatedAnnealingDyn::compute(std::vector<CTaskCopy>* pTasks, std::vector<CTaskCopy*>* runningTasks, volatile int* interrupt, int updated) {
