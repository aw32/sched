...
CScheduleAlgorithmGeneticMig::CGeneticSchedule::CGeneticSchedule(int max_num, int machines) {
...
CScheduleAlgorithmGeneticMig::SPart* CScheduleAlgorithmGeneticMig::CGeneticSchedule::get(int mix, int rix) {

	return &(tasks[mix*max_num + rix]);

}

bool CScheduleAlgorithmGeneticMig::CGeneticSchedule::find(int tid, int part, int* mixout, int* rixout) {
...
bool CScheduleAlgorithmGeneticMig::CGeneticSchedule::check (){
...
void CScheduleAlgorithmGeneticMig::CGeneticSchedule::printTask(int mix, int rix){
...
void CScheduleAlgorithmGeneticMig::CGeneticSchedule::print(){
...
CScheduleAlgorithmGeneticMig::CGeneticSchedule* CScheduleAlgorithmGeneticMig::CGeneticSchedule::copy(){
	CGeneticSchedule* c = new CGeneticSchedule(max_num, machines);
	this->transfer(c);
	return c;
}

void CScheduleAlgorithmGeneticMig::CGeneticSchedule::transfer(CGeneticSchedule* b){
	if (this == b) {
...
CScheduleAlgorithmGeneticMig::CGeneticSchedule::~CGeneticSchedule(){
...
CScheduleAlgorithmGeneticMig::CScheduleAlgorithmGeneticMig(std::vector<CResource*>& rResources, enum EGeneticFitnessType fitness)
...
CScheduleAlgorithmGeneticMig::~CScheduleAlgorithmGeneticMig(){
	delete mpEstimation;
	mpEstimation = 0;
}

int CScheduleAlgorithmGeneticMig::init() {
...
void CScheduleAlgorithmGeneticMig::fini() {
}

CScheduleAlgorithmGeneticMig::CGeneticSchedule* CScheduleAlgorithmGeneticMig::generateSchedule(
...
bool CScheduleAlgorithmGeneticMig::mutate(CGeneticSchedule* sched, int* height, int machines, int height_num, std::vector<int>* height_sets, int max_num) {
...
void CScheduleAlgorithmGeneticMig::crossover(CGeneticSchedule* a, CGeneticSchedule* b, int height_num, int machines, int* height, int max_num){
...
void CScheduleAlgorithmGeneticMig::reproduction(std::vector<CGeneticSchedule*>* pop, std::vector<CGeneticSchedule*>* newpop){
...
void CScheduleAlgorithmGeneticMig::fitness(CGeneticSchedule* sched, int tasks, std::vector<int>* height_sets, int* height, int machines, int height_num, std::vector<CTaskCopy>* pTasks, int max_num, std::unordered_map<int,int>* taskmap,double double_max, std::vector<CTaskCopy*>* runningTasks){
...
void CScheduleAlgorithmGeneticMig::fitnessMakespan(CGeneticSchedule* sched, int tasks, std::vector<int>* height_sets, int* height, int machines, int height_num, std::vector<CTaskCopy>* pTasks, int max_num, std::unordered_map<int,int>* taskmap, double double_max, std::vector<CTaskCopy*>* runningTasks){
	...
	std::vector<CTaskCopy*> emptyTasks;
	CScheduleAlgorithmGeneticMigSolverLP::solve(sched, mrResources, mpEstimation, pTasks, taskmap, double_max, &emptyTasks, mpSolverPath);
...
void CScheduleAlgorithmGeneticMig::fitnessEnergy(CGeneticSchedule* sched, int tasks, std::vector<int>* height_sets, int* height, int machines, int height_num, std::vector<CTaskCopy>* pTasks, int max_num, std::unordered_map<int,int>* taskmap, double double_max, std::vector<CTaskCopy*>* runningTasks){
	...
	std::vector<CTaskCopy*> emptyTasks;
	CScheduleAlgorithmGeneticMigSolverLPEnergy::solve(sched, mrResources, mpEstimation, pTasks, taskmap, double_max, &emptyTasks, mpSolverPath);

}


CSchedule* CScheduleAlgorithmGeneticMig::compute(std::vector<CTaskCopy>* pTasks, std::vector<CTaskCopy*>* runningTasks, volatile int* interrupt, int updated) {
