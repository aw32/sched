...
CScheduleAlgorithmMCT::CScheduleAlgorithmMCT(std::vector<CResource*>& rResources)
	: CScheduleAlgorithm(rResources)
{
	mpEstimation = CEstimation::getEstimation();
}

CScheduleAlgorithmMCT::~CScheduleAlgorithmMCT(){
	delete mpEstimation;
	mpEstimation = 0;
}

int CScheduleAlgorithmMCT::init() {
	return 0;
}

void CScheduleAlgorithmMCT::fini() {
}

CSchedule* CScheduleAlgorithmMCT::compute(std::vector<CTaskCopy>* pTasks, std::vector<CTaskCopy*>* runningTasks, volatile int* interrupt, int updated) {
