...
CScheduleAlgorithmSimulatedAnnealingMig::CScheduleAlgorithmSimulatedAnnealingMig(std::vector<CResource*>& rResources, enum EGeneticFitnessType fitness)
	: CScheduleAlgorithmGeneticMig(rResources, fitness)
{
...
CScheduleAlgorithmSimulatedAnnealingMig::~CScheduleAlgorithmSimulatedAnnealingMig(){
}

int CScheduleAlgorithmSimulatedAnnealingMig::init() {
...
void CScheduleAlgorithmSimulatedAnnealingMig::fini() {
	CScheduleAlgorithmGeneticMig::fini();
}

void CScheduleAlgorithmSimulatedAnnealingMig::randomize(CGeneticSchedule* schedule, int* height, int machines, int height_num, std::vector<int>* height_sets, int max_num){
...
CSchedule* CScheduleAlgorithmSimulatedAnnealingMig::compute(std::vector<CTaskCopy>* pTasks, std::vector<CTaskCopy*>* runningTasks, volatile int* interrupt, int updated) {
