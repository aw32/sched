...
CScheduleAlgorithmMaxMin2::CScheduleAlgorithmMaxMin2(std::vector<CResource*>& rResources)
	: CScheduleAlgorithm(rResources)
{
	mpEstimation = CEstimation::getEstimation();
}

CScheduleAlgorithmMaxMin2::~CScheduleAlgorithmMaxMin2() {
	delete mpEstimation;
	mpEstimation = 0;
}

int CScheduleAlgorithmMaxMin2::init() {
	return 0;
}

void CScheduleAlgorithmMaxMin2::fini() {
}

CSchedule* CScheduleAlgorithmMaxMin2::compute(std::vector<CTaskCopy>* pTasks, std::vector<CTaskCopy*>* runningTasks, volatile int* interrupt, int updated) {
